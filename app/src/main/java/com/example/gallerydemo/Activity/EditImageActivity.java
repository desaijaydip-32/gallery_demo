...
public class EditImageActivity extends  AppCompatActivity {
        //implements OnPhotoEditorListener, View.OnClickListener,
...
//    private ConstraintLayout mRootView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // mPhotoEditor = findViewById(R.id.photoEditorView);
        ...
        Glide.with(this).load(path1).into((ImageView) mPhotoEditor);
        ...
        if (hasStoragePermission || isSdkHigherThan28()) {
            ...
            mSaveFileHelper.createFile(fileName, (fileCreated, filePath, error, uri) -> {
                if (fileCreated) {
                    ...
                    mPhotoEditor.saveAsFile(path1, saveSettings, new PhotoEditor.OnSaveListener() {
                        @Override
...
//        mTxtCurrentTool.setText("Sticker");
//    }
...
//    @Override
//    public void onFilterSelected(ja.burhanrashid52.photoeditor.PhotoFilter photoFilter) {
//        mPhotoEditor.setFilterEffect(photoFilter);
//    }
